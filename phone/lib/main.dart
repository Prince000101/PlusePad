...
void main() async {
  ...
  // Start PORTRAIT. The controller screen switches to landscape when it opens
  // (see ControllerScreen) and back to portrait when it closes — the menu /
  // editor / connection screens stay portrait.
